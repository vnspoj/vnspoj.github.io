...
(function () {
  ...
  const searchInputEl = document.querySelector('#js-search__input');
  const searchResultsEl = document.querySelector('#js-search__results');
  const searchNoResultsEl = document.querySelector('#js-search__no_results');
  const searchMoreResultsEl = document.querySelector('#js-search__more_results');
