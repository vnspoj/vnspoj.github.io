...
![Example-image of the set representation with trees](/static/wiki/img/DSU_example.png)
...
![Path compression of call `find_set(7)`](/static/wiki/img/DSU_path_compression.png)
