...
The algorithm from D´Esopo-Pape will work faster than [Dijkstra's algorithm](../graph/dijkstra) and the [Bellman-Ford algorithm](../graph/bellman_ford) in most cases, and will also work for negative edges.
