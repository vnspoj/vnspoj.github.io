...
For an explanation of the MST problem and the Kruskal algorithm, first see the [main article on Kruskal's algorithm](../graph/mst_kruskal).
...
See [main article on Kruskal's algorithm](../graph/mst_kruskal) for the list of practice problems on this topic.
